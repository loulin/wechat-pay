...
Payment.prototype.micropay = function(params, callback) {
  this._signedQuery(URLS.MICROPAY, params, {
    https: true,
    required: ['out_trade_no', 'total_fee', 'spbill_create_ip', 'auth_code', 'body'],
  }, callback);
};

Payment.prototype.reverse = function(params, callback) {
  this._signedQuery(URLS.REVERSE, params, {
    https: true,
    required: ['transaction_id|out_trade_no'],
  }, callback);
};
